...
class SiginIn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.signinBtn2).setOnClickListener {
            val intent = Intent(this@SiginIn, SignUp::class.java)
            startActivity(intent)
        }

        findViewById<View>(R.id.order).setOnClickListener {
            val intent = Intent(this@SiginIn, MainActivity::class.java)
            startActivity(intent)
        }
    }
}